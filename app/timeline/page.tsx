...
const SPECIES: Species[] = [
  ...
  },
  {
    ...
    timeline:[
      {era:'1870s–1930s', items:[
        {y:'1870s–1930s',t:'Common to very abundant, especially 1920s–1930s',d:'The Clear Lake splittail, endemic to the Clear Lake basin, thrives through this period. Found nowhere else on Earth, it is a cornerstone of the native fish assemblage.',tag:'good'},
      ]},
      {era:'1940s', items:[
        {y:'~1940',t:'Rapid collapse begins',d:'The splittail collapses in parallel with the hitch around 1940–1943 — nearly certainly driven by the same stressors. By the mid-1940s it is nearly absent from the lake.',tag:'danger'},
      ]},
  ...
  },
  {
    ...
    scores:[4,5,5,5,5,5],
    summary:'Introduced in 1880 alongside carp, catfish species quickly became commercially dominant — comprising 80% of the commercial catch by the 1930s–1951. The commercial fishery subsequently collapsed and was closed in 1949, partly from DDD contamination. Catfish persist at abundant levels and continue to be stocked for sport fishing.',
    timeline:[
  ...
  },
  {
    ...
    scores:[4,5,5,5,5,5],
    summary:'Introduced around 1909–1910 and consistently abundant since. Bluegill remain one of the most abundant fish in Clear Lake and a popular sport fish target. They compete with juvenile native fish and contribute to the overall restructuring of the lake\'s food web.',
    timeline:[
      {era:'All periods', items:[
...
const timelineData: TimelineEra[] = [
  ...
  },
  {
    ...
    dotColor: "#a0b8c8",
    intro: "A cascade of non-native fish introductions over 80 years fundamentally restructured Clear Lake's fish community — before most people realized what was being lost.",
    introColor: "blue",
    items: [
      {
        year: "1860s–1870s",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        detail: "The U.S. Geological Survey publishes Open-File Report 2025-1018, documenting gillnet survey results from 2017 through 2022. The report confirms a 96% decline in hitch relative abundance and shows non-native species dominating Clear Lake's fish assemblage — over 20 introduced species established.",
