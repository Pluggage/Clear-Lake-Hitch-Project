...
export interface Creek {
  ...
  searchName: string
  status: CreekStatus
  /** representative card photo; flagship creeks with real photos only */
  image?: string
  location: string
  description: string
...
export const creeks: Creek[] = [
  ...
  {
    href: '/creek/alley-creek', name: 'Alley Creek', searchName: 'alley creek', status: 'none',
    image: '/creek-photos/alley-creek/02.webp',
  ...
  {
    href: '/creek/clover-creek', name: 'Clover Creek', searchName: 'clover creek', status: 'none',
    image: '/creek-photos/clover-creek/01.webp',
  ...
  {
    href: '/creek/cole', name: 'Cole Creek', searchName: 'cole creek', status: 'concern',
    image: '/creek-photos/cole/04.webp',
  ...
  {
    href: '/creek/cooper-creek', name: 'Cooper Creek', searchName: 'cooper creek', status: 'none',
    image: '/creek-photos/cooper-creek/03.webp',
  ...
  {
    href: '/creek/copsey', name: 'Copsey Creek', searchName: 'copsey creek', status: 'active',
    image: '/creek-photos/copsey/01.webp',
  ...
  {
    href: '/creek/dayle-creek', name: 'Dayle Creek', searchName: 'dayle creek', status: 'none',
    image: '/creek-photos/dayle-creek/01.webp',
  ...
  {
    href: '/creek/hendricks', name: 'Hendricks Creek', searchName: 'hendricks creek', status: 'active',
    image: '/creek-photos/hendricks/02.webp',
    location: 'N shore, Scotts Creek feeder',
  ...
  {
    href: '/creek/highland-creek', name: 'Highland Creek', searchName: 'highland creek', status: 'none',
    image: '/creek-photos/highland-creek/01.webp',
  ...
  {
    href: '/creek/hill', name: 'Hill Creek', searchName: 'hill creek', status: 'none',
    image: '/creek-photos/hill/01.webp',
  ...
  },
  {
    ...
    image: '/creek-photos/kelsey/09.webp',
  ...
  {
    href: '/creek/lucerne', name: 'Lucerne Creek', searchName: 'lucerne creek', status: 'none',
    image: '/creek-photos/lucerne/01.webp',
  ...
  {
    href: '/creek/lyons', name: 'Lyons Creek', searchName: 'lyons creek', status: 'none',
    image: '/creek-photos/lyons/01.webp',
  ...
  {
    href: '/creek/manning', name: 'Manning Creek', searchName: 'manning creek', status: 'active',
    image: '/creek-photos/manning/03.webp',
  ...
  {
    href: '/creek/mcgaugh', name: 'McGaugh Slough', searchName: 'mcgaugh slough', status: 'none',
    image: '/creek-photos/mcgaugh/01.webp',
  ...
  {
    href: '/creek/middle-creek', name: 'Middle Creek', searchName: 'middle creek', status: 'none',
    image: '/creek-photos/middle-creek/02.webp',
  ...
  {
    href: '/creek/morrison', name: 'Morrison Creek', searchName: 'morrison creek', status: 'none',
    image: '/creek-photos/morrison/01.webp',
  ...
  {
    href: '/creek/perini-creek', name: 'Perini Creek', searchName: 'perini creek', status: 'none',
    image: '/creek-photos/perini-creek/01.webp',
    location: 'East shore, Seigler Canyon system',
  ...
  {
    href: '/creek/pool-creek', name: 'Pool Creek', searchName: 'pool creek', status: 'none',
    image: '/creek-photos/pool-creek/01.webp',
  ...
  {
    href: '/creek/rodman-slough', name: 'Rodman Slough', searchName: 'rodman slough', status: 'active',
  ...
  {
    href: '/creek/rumsey', name: 'Rumsey Slough', searchName: 'rumsey slough', status: 'none',
    image: '/creek-photos/rumsey/01.webp',
  ...
  {
    href: '/creek/schindler', name: 'Schindler Creek', searchName: 'schindler creek', status: 'none',
    image: '/creek-photos/schindler/01.webp',
  ...
  {
    href: '/creek/scotts-creek', name: 'Scotts Creek', searchName: 'scotts creek', status: 'active',
    image: '/creek-photos/scotts-creek/01.webp',
  ...
  {
    href: '/creek/seigler-system', name: 'Seigler Canyon Creek', searchName: 'seigler canyon creek', status: 'concern',
    image: '/creek-photos/seigler-system/03.webp',
  ...
  {
    href: '/creek/thompson', name: 'Thompson Creek', searchName: 'thompson creek', status: 'active',
    image: '/creek-photos/thompson/02.webp',
