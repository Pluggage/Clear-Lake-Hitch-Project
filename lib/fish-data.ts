...
export const FISH: Fish[] = [
  ...
  {name:"Sacramento Pikeminnow",sci:"Ptychocheilus grandis",type:"native",status:"",desc:"California's largest native minnow, capable of exceeding 1 meter in length. Once an abundant apex predator in Clear Lake through the 1930s, it crashed toward extinction by 1951 and is now considered functionally extirpated from the lake, though it persists in other California watersheds.",family:"Leuciscidae",order:"Cypriniformes"},
  ...
  {name:"Bluegill",sci:"Lepomis macrochirus",type:"introduced",status:"",introYear:"1909 to 1910",desc:"Introduced in 1909 to 1910. One of the most abundant introduced sunfish in Clear Lake.",family:"Centrarchidae",order:"Perciformes"},
  ...
  {name:"Florida Largemouth Bass",sci:"Micropterus salmoides floridanus",type:"introduced",status:"",introYear:"1969 to 1971",desc:"Introduced from Florida between 1969 and 1971. A top predator consuming juvenile native fish including hitch. Mercury advisory in effect.",family:"Centrarchidae",order:"Perciformes"},
